...
export default function EmergencyPage() {
  ...
  return (
    <div className="ep-root">
      ...
      <main className="ep-main">
        ...
        <div className="ep-brand">
          <div className="ep-logo-circle" aria-hidden="true">
            <img src="/image.png" alt="" className="eris-shield eris-shield--lg" />
          </div>
      ...
      {/* Bottom bar (high visibility actions) */}
      <footer className="ep-bottombar">
        <div className="ep-bottombar-left">
          <Link to="/home" className="btn-secondary ep-bottombar-btn">
            Staff dashboard
          </Link>
          <Link to="/patient" className="btn-secondary ep-bottombar-btn">
            Book with details
          </Link>
        </div>
        <div className="ep-bottombar-right">
          <button type="button" className="btn-emergency ep-bottombar-btn" onClick={handlePanicClick} disabled={loading}>
