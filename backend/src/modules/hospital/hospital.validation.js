...
const createHospitalSchema = Joi.object({
  ...
  icuBedsAvailable: Joi.number().integer().min(0).optional(),
  generalBedsAvailable: Joi.number().integer().min(0).optional(),
  ventilatorsAvailable: Joi.number().integer().min(0).optional()
});
